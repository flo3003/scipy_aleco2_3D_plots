...
from .optimize import (_minimize_neldermead, _minimize_powell, _minimize_cg,
                      _minimize_gd, _minimize_aleco2, _minimize_gdm, _minimize_adagrad,
                      _minimize_rmsprop, _minimize_adam,
...
def minimize(fun, x0, args=(), method=None, jac=None, hess=None,
    ...
    method : str or callable, optional
        Type of solver.  Should be one of
            ...
            - 'ALECO2'      :ref:`(see here) <optimize.minimize-aleco2>`
    ...
    **Unconstrained minimization**
    ...
    Method :ref:`ALECO2 <optimize.minimize-aleco2>`ALECO2 belongs to the
    class of Algorithms for Learning Efficiently with Constrained Optimization
    (ALECO) and this version (2) uses Adaptive Momentum. ALECO is a class of
    very efficient algorithms for training feedforward neural networks.
    More details of the algorithms can be found in [13]_, [14]_
    ...
    **Custom minimizers**
    ...
    .. [13] Karras, D A and Perantonis, S J. An efficient constrained training
       algorithm for feedforward networks. IEEE Transactions on Neural
       Networks 6 (6): 1420-1434
    .. [14] Perantonis, S J and Karras, D A. An efficient constrained learning
    ...
    if meth == '_custom':
        ...
        return _minimize_gd(fun, x0, args, jac, callback, **options)
    elif meth == 'aleco2':
        return _minimize_aleco2(fun, x0, args, jac, callback, **options)
    elif meth == 'gdm':
        return _minimize_gdm(fun, x0, args, jac, callback, **options)
    elif meth == 'adagrad':
        return _minimize_adagrad(fun, x0, args, jac, callback, **options)
    elif meth == 'adam':
        return _minimize_adam(fun, x0, args, jac, callback, **options)
    elif meth == 'rmsprop':
        return _minimize_rmsprop(fun, x0, args, jac, callback, **options)
    elif meth == 'bfgs':
